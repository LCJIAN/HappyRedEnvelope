...
public class LuckCardHistoriesActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luck_card_histories);
        ButterKnife.bind(this);

        btn_top_bar_left.setOnClickListener(this);
        tv_top_bar_title.setText(R.string.luck_card_history);
        tv_top_bar_right.setVisibility(View.GONE);
        getSupportFragmentManager().beginTransaction().add(R.id.fl_luck_card_histories_container,
                new LuckCardHistoriesFragment()).commit();
    }
